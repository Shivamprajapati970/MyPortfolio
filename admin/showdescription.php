...
<body class="maxw1600 m0a dashboard-bd">
    ...
    <main id="main" class="main container-table-res">
        ...
        <div class="container-fluid mt-5 ">
            <h1>All Properties-User Description</h1>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($row['twitter']); ?></td>
                                <td><?php echo htmlspecialchars($row['facebook']); ?></td>
                                <td><?php echo htmlspecialchars($row['instagram']); ?></td>
                                <td><?php echo htmlspecialchars($row['google-plus']); ?></td>
                                <td><?php echo htmlspecialchars($row['linkedin']); ?></td>
                                <td><img src="<?php echo htmlspecialchars($row['backimage']); ?>" alt="background image"></td>
                                
                                <td>
                                    <!-- Update Button -->
                                    <a href="updatedescription.php?id=<?php echo $row['sno']; ?>" class="btn btn-primary btn-sm">Update</a>
                                </td>
                            </tr>
                    <?php
